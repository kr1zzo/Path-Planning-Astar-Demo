...
def a_star(grid, start, end):
    ...
    #score with obstacle factor
    start.g_score = 0

    #score without obstacle factor
        ...
        for neighbor in current.get_neighbors():
            ...
            if neighbor in closed_set or neighbor.type == 'wall_area_2' or neighbor.type == 'wall_area_3' or neighbor.type == 'wall_area_1':
                if neighbor.type == 'wall_area_2':
                    obstacle_factor = 1.5
                elif neighbor.type == 'wall_area_3':
                    obstacle_factor = 1.2
                elif neighbor.type == 'wall_area_1':
                    obstacle_factor = 10
                #continue
            ...
            if adj_node_1.type == 'wall' and adj_node_2.type == 'wall': #or neighbor.type == 'wall_area_1':
                continue
            
            distance_to_neighbour = distance(current, neighbor) #1 or 1.41

            tentative_g_score = current.g_score + distance_to_neighbour * obstacle_factor
